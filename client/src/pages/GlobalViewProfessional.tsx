          ...
          <div className="p-4" style={{ backgroundColor: '#020817' }}>
            ...
            <div className="grid grid-cols-6 gap-3 mb-4">
              {[
                ...
                <div key={i} className="rounded border p-3 shadow" style={{ backgroundColor: 'rgba(30, 58, 138, 0.4)', borderColor: 'rgba(30, 58, 138, 0.6)' }}>
            ...
            <div className="grid grid-cols-[280px_1fr_320px] gap-3 mb-4">
              ...
              <div className="space-y-3">
                ...
                {/* BEST OPTION */}
                <div className="rounded border-2 p-3 shadow" style={{ backgroundColor: 'rgba(34, 197, 94, 0.05)', borderColor: 'rgba(34, 197, 94, 0.3)' }}>
